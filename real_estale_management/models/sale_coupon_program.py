...
class SaleCouponProgram(models.Model):
    ...
    def _check_promo_code(self, order, coupon_code):
        print("3::::COUPON======>Đã vào hàm, order: ", order, ", coupon_code: ", coupon_code)
        message = {}
        applicable_programs = order._get_applicable_programs()
        print("3::::COUPON, coupon_program,======>", applicable_programs)
    ...
    def _compute_program_amount(self, field, currency_to):
        print("7::::==> Đã vào!", "self: ", self, "field", field, "currency_to", currency_to)
        self.ensure_one()
        print("7::::=>1",", currency_id:", self.currency_id, ", company_id:", self.company_id, "fields.Date.today()", fields.Date.today())
    ...
    def _filter_on_mimimum_amount(self, order):
        ...
        print("5::::SALE_COUPON====>>> Đã vào _filter_on_mimimum_amount")
        ...
        print("5::::SALE_COUPON====>>> untaxed_amount", untaxed_amount, "tax_amount", tax_amount)
    ...
    def _filter_programs_from_common_rules(self, order, next_order=False):
        ...
        """
        print("4:::,SALE:COUPON _filter_programs_from_common_rules====>>>>")
        programs = self
        ...
        if not next_order:
            print("4::->1, programs: ", programs, "order: ",order, "next_order: ",next_order)
